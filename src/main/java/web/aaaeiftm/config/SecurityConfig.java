        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .formLogin(form -> form
                                                ...
                                                // Define a URL para o caso de sucesso no login se nenhuma URL segura
                                                // foi acessada anteriormente ou solicitada
                                                .defaultSuccessUrl("/")
                                                .permitAll())
                                .logout(logout -> logout.permitAll()
                                                // Para fazer logout (já é configurado automaticamente para a URL
                                                // /logout)
